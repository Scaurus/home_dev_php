...
<div id="maket">
	...
	<div id="content">
		<div id="content_player">
			<script type="text/javascript" src="js/player.js"></script> <script class="splayer"> var params = {"playlist":[{"title":"sdfsdf","posterUrl":"","video":[{"url":"http://zh-r.me/video/01-programming-basics.mp4"}],"duration":0}],"uiLanguage":"ru","width":"640","height":"360"}; player.embed(params); </script>
		</div>
		<div id = "description"
